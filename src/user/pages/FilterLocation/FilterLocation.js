...
import { getRoomLocation } from "../../api/apiUser";
import { NavLink, useParams } from "react-router-dom";
import "./responsiteFilterLocation.css";
const FilterLocation = () => {
  ...
  return (
    <div className="container">
      <div className="mt-16 mb-6 space-y-6 topContentFilter">
              ...
              >
                ...
                >
                  ...
                  <div className="flex space-x-3">
                    <p>{item.khach} khách</p>
                    <span> . </span>
                    <p>{item.giuong} giường</p>
                    <span> . </span>
                    <p>{item.phongNgu} phòng ngủ</p>
                    <span> . </span>
                    <p>{item.phongTam} phòng tắm</p>
                  </div>
        ...
        <div className="contentFilterSmall space-y-6">
          {roomLocation.map((item, index) => {
            return (
              <div
                className="bg-white shadow-xl border rounded-xl contentFilterLocation"
                style={{
                  width: "100%",
                }}
                key={index}
