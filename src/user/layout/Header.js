...
const Header = () => {
  ...
  const handleToggle1SM = () => {
    document.querySelector(".hedCotShowSM").style.display = "none";
    document.querySelector(".hedCotHiddenSM").style.display = "block";
  };
  const handleToggle2SM = () => {
    document.querySelector(".hedCotShowSM").style.display = "block";
    document.querySelector(".hedCotHiddenSM").style.display = "none";
  };
      ...
      <div className="container">
        ...
        <div className="small_header">
          ...
          <div className="flex justify-center mt-3 mb-3">
            {/* search */}
            <div className="hedCotShowSM">
              <button
                className=" flex items-center space-x-2 py-2  rounded-full border border-gray-300 px-3 text-base"
                onClick={handleToggle1SM}
              >
                <div className="diaDiemBatKi">
                  <p>Địa điểm bất kì</p>
                </div>
